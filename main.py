...
from src.visualization.line_bar_plot import (
    create_line_bar_plot,             # Giữ lại import để tránh lỗi, mặc dù không dùng trong menu
    create_line_bar_time_series_plot  # Time Series Trend
)


# Placeholder functions for Visualization modules (không cần thiết vì đã xóa khỏi menu, nhưng giữ lại cấu trúc)
...
def run_visualization_plots():
    """
    Displays the Visualization submenu và chỉ giữ lại chức năng P1.
    """
    ...
    while True:
        ...
        if vis_choice=='3.1':
            ...
            create_line_bar_time_series_plot(
                input_path=INPUT_MERGED_PATH,  # Sử dụng dữ liệu đã gộp chính xác
            ...
            print("Invalid choice. Please re-enter (e.g., 3.1 or 3.2).")
